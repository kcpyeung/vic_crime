...
The regression model tells us population size has nothing to do with crime rate. Every suburb has, on average, 925 crimes against the person per 100,000 people in 2016 irrespective of population size.
...
Again, population size has no correlation with property and deception crimes.

How about income and unemployment?

## Does crime rate correlate with income and unemployment?

Let's load income and unemployment data.
